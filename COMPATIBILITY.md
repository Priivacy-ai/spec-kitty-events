...
## `9.0.1` — timestamp parsing normalized across supported Python versions

`9.0.1` is a parser bug fix, not a new event family or payload field. The
...
fractional-second precision and basic-format timestamps that Python 3.11+
already accepted. No producer or consumer migration is required.
